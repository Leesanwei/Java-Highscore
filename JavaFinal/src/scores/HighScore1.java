...
public class HighScore1 {
	...
	public String[] getScores() throws MalformedURLException{
		...
		try {
			// Mise en place de l'url pour r閏up閞er le fichier et ouverture d'un flux entrant
			url = new URL("https://api.thingspeak.com/channels/110013/feeds.csv");
			is = url.openStream();
			//Lecture du fichier qui va 阾re stock� dans une liste dynamique en attendant d'阾re d閜lac� vers un tableau de String
